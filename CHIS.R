...
str(adult)
adult <- select(CHIS,RBMI = rbmi,BMI_P = bmi_p, RACEHPR2 = racehpr2,SRSEX = srsex, SRAGE_P = srage_p,MARIT2 = marit2,AB1 = ab1,ASTCUR = astcur,AB51 = ab51,POVLL = povll)
...
# remove other races and keep only 4 
adult <- adult[adult$RACEHPR2 == "LATINO" |adult$RACEHPR2 == "ASIAN" | adult$RACEHPR2 == "AFRICAN AMERICAN"  | adult$RACEHPR2 == "WHITE" , ]
...
fix_strips <- theme(strip.text.y = element_text(angle = 180, hjust = 0, vjust = 0.1, size = 14),
...
mosaicGG <- function(data, X, FILL, x_lbl = "Individuals") {
  ...
  g <- ggplot(DF_all, aes(ymin = ymin,  ymax = ymax, xmin = xmin, 
    ...
    scale_x_continuous(x_lbl, expand = c(0,0)) +
...
mosaicGG(data = mtcars, X = "cyl", FILL =  "am", x_lbl = "Cylinders")

library(car)
# Vocab: vocabulary described by education
 
mosaicGG(data = Vocab,X = "education", FILL = "vocabulary", x_lbl = "Education")
